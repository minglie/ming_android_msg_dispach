...
public class NotifyService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn, RankingMap rankingMap) {
        ...
        if(TextUtils.isEmpty(NotifyService.packageName)||!packageName.equals(NotifyService.packageName)){
            return;
        }
        Log.i("QQQQQQQQQQQQQQQQQQQQQ",packageName);
        Log.i("RRRRRRRRRRRRRRRRRRR",NotifyService.packageName);
        String content = null;
        //获取通知栏消息中的文字
